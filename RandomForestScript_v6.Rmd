...
# Crea una tabla de correspondencia ID <-> CLAVE_WRB
tabla_clave <- as.data.frame(unidades_vect)[, c("ID", "CLAVE_WRB")]
# Une por ID
extr <- merge(extr, tabla_clave, by="ID")

# 4. Entrenar Random Forest
set.seed(42)
# Selecciona solo las columnas de los ráster y la clase
pred_cols <- names(stack)
library(dplyr)
set.seed(42)
...
# 5. Predecir la clase para cada píxel del stack
